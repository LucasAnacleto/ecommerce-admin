...
export const SizeForm: React.FC<SizeFormProps> = ({
  ...
  const description = initialData ? 'Editar o tamanho.' : 'Adicionar o novo tamanho';
  ...
  const onDelete = async () => {
    try {
      ...
      toast.error('Certifique-se de remover todas os produtos usando este tamanho de avisos primeiro.');
    } finally {
      setLoading(false);
      setOpen(false);
    }
