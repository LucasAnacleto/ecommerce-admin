...
export const ColorForm: React.FC<ColorFormProps> = ({
  ...
  const description = initialData ? 'Editar o cor.' : 'Adicionar nova cor';
  ...
  const onDelete = async () => {
    try {
      ...
      toast.error('Certifique-se de remover todas os produtos usando esta cor de avisos primeiro.');
    } finally {
      setLoading(false);
      setOpen(false);
    }
